...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            final JPanel manageTeamCard = createManageTeamCard(frame, leaveTeamUseCase, getAverageGradeUseCase,  getTopGradeUseCase, getBottomGradeUseCase);
    ...
    private static JPanel createManageTeamCard(JFrame jFrame, LeaveTeamUseCase leaveTeamUseCase,
                                               GetAverageGradeUseCase getAverageGradeUseCase, GetTopGradeUseCase getTopGradeUseCase, GetBottomGradeUseCase getBottomGradeUseCase) {
        final JPanel theCard = new JPanel();
        theCard.setLayout(new GridLayout(ROWS, COLS));
        final JTextField courseField = new JTextField(20);
        ...
        getBottomButton.addActionListener(new ActionListener() {
            /**
             * Invoked when an action occurs.
             *
             * @param e the event to be processed
